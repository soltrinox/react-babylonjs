...
var mutation = {
    ...
    insertInContainerBefore: function insertInContainerBefore(parentInstance, child,
    ...
    removeChildFromContainer: function removeChildFromContainer(parentInstance,
    // eslint-disable-next-line no-unused-vars
    child) {
...
var BabylonJSRenderer = ReactFiberReconciler({
    ...
    commitTextUpdate: function commitTextUpdate(textInstance, oldText,
    // eslint-disable-next-line no-unused-vars
    newText) {
        throw new ErrorNotImplemented();
    }
